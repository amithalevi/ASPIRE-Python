#Our first python script!  I'm so excited!  The purpose of this script is going to be to generate example volumes for the dataset used in the InvProb paper ('FakeKv').

#Written by Amit Halevi (on the keyboard) and Amit Moscovich (moral support).
#ahalevi@princeton.edu
